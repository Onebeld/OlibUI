...
namespace OlibUI.Controls
{
    ...
    public class ColorToBrushConverter : IValueConverter
    {
        ...
        {
            if (value is Color s && targetType == typeof(IBrush))
            {
                try
                {
        ...
        {
            if (value is SolidColorBrush c && targetType == typeof(Color))
            {
                try
                {
                    return c.Color;
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (value is string s && targetType == typeof(IBrush))
            {
                try
                {
                    ...
                    {
                        return new SolidColorBrush{ Color = ColorHelpers.FromHexColor(s) };
                    }
                }
                catch (Exception)
                {
